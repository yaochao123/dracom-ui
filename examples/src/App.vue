<template>
  <div id="app">
    ...
    <dr-button color="linear-gradient(to right, rgb(75, 176, 255), rgb(97, 73, 246))">渐变按钮</dr-button>
    <dr-button
      miniRange
      type="primary"
    >小圆角按钮</dr-button>
    ...
    <dr-button
      ...
      plain
    >单色按钮</dr-button>
    <dr-button icon="https://micro-store.oss-cn-hangzhou.aliyuncs.com/202004/583154291799101440.png">图标按钮</dr-button>
